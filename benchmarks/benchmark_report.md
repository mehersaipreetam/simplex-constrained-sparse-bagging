...
| | DecisionTree | Lasso-Pruned Bagging | 0.9415 | 0.2064 | 0.0518 | 86 | 14.0% | 20.91 |
| | DecisionTree | **SCSB** | **0.9532** | 0.2173 | 0.0538 | **11** | **89.0%** | **8.52** (2.6x speedup) |
| | LogisticRegression | Standard Bagging | 0.9708 | 0.0967 | 0.0387 | 50 | 0.0% | 17.51 |
| | LogisticRegression | Lasso-Pruned Bagging | 0.9708 | 0.0964 | 0.0392 | 46 | 8.0% | 15.35 |
| | LogisticRegression | **SCSB** | **0.9766** | **0.0934** | **0.0354** | **10** | **80.0%** | **5.75** (3.0x speedup) |
...
| | DecisionTree | Lasso-Pruned Bagging | 0.7273 | 0.5786 | 0.1415 | 90 | 10.0% | 18.91 |
| | DecisionTree | **SCSB** | **0.7316** | 0.5971 | 0.1481 | **31** | **69.0%** | **8.53** (2.6x speedup) |
| | LogisticRegression | Standard Bagging | 0.7316 | 0.5193 | 0.4406 | 50 | 0.0% | 25.68 |
| | LogisticRegression | Lasso-Pruned Bagging | 0.7316 | 0.5169 | 0.4362 | 42 | 16.0% | 18.91 |
| | LogisticRegression | **SCSB** | **0.7446** | 0.5270 | 0.4462 | **10** | **80.0%** | **7.41** (3.5x speedup) |
| | N/A | XGBoost | 0.7143 | 0.8153 | 0.5562 | 100 | 0.0% | 16.60 |
| **spambase** | DecisionTree | Standard Bagging | 0.9406 | 0.1839 | 0.5290 | 100 | 0.0% | 28.73 |
| | DecisionTree | Lasso-Pruned Bagging | 0.9421 | 0.1859 | 0.5321 | 96 | 4.0% | 20.36 |
| | DecisionTree | **SCSB** | **0.9457** | 0.2748 | 0.5320 | **31** | **69.0%** | **8.53** (3.4x speedup) |
| | LogisticRegression | Standard Bagging | 0.9327 | 0.2018 | 0.5205 | 50 | 0.0% | 17.33 |
| | LogisticRegression | Lasso-Pruned Bagging | 0.9334 | 0.2017 | 0.5218 | 48 | 4.0% | 6.47 |
| | LogisticRegression | **SCSB** | **0.9385** | **0.1982** | 0.5290 | **16** | **68.0%** | **3.06** (5.7x speedup) |
| | N/A | XGBoost | 0.9580 | 0.1201 | 0.5495 | 100 | 0.0% | 0.99 |
| **segment** | DecisionTree | Standard Bagging | 0.9740 | 0.1889 | 0.0235 | 100 | 0.0% | 22.56 |
| | DecisionTree | Lasso-Pruned Bagging | 0.9740 | 0.1870 | 0.0233 | 100 | 0.0% | 19.92 |
| | DecisionTree | **SCSB** | 0.9553 | 0.3276 | 0.0373 | **26** | **74.0%** | **7.15** (3.2x speedup) |
| | LogisticRegression | Standard Bagging | 0.9509 | 0.1548 | 0.0190 | 50 | 0.0% | 31.23 |
| | LogisticRegression | Lasso-Pruned Bagging | 0.9509 | 0.1543 | 0.0216 | 50 | 0.0% | 19.12 |
| | LogisticRegression | **SCSB** | 0.9509 | **0.1526** | **0.0211** | **13** | **74.0%** | **7.02** (4.4x speedup) |
...
| | DecisionTree | Lasso-Pruned Bagging | 2998.13 | 0.4446 | 53 | 47.0% | 27.57 |
| | DecisionTree | **SCSB** | 3118.37 | 0.4223 | **34** | **66.0%** | **19.53** (2.2x speedup) |
| | Ridge | Standard Bagging | 3116.53 | 0.4227 | 50 | 0.0% | 19.89 |
| | Ridge | Lasso-Pruned Bagging | 3123.13 | 0.4215 | 39 | 22.0% | 10.55 |
| | Ridge | **SCSB** | **3075.70** | **0.4302** | **12** | **76.0%** | **5.73** (3.5x speedup) |
| | N/A | XGBoost | 3513.66 | 0.3491 | 100 | 0.0% | 4.61 |
| **california_housing**| DecisionTree | Standard Bagging | 0.3424 | 0.7429 | 100 | 0.0% | 14.97 |
| | DecisionTree | Lasso-Pruned Bagging | 0.3394 | 0.7452 | 99 | 1.0% | 17.36 |
| | DecisionTree | **SCSB** | **0.3381** | **0.7461** | **67** | **33.0%** | **11.95** (1.25x speedup) |
| | Ridge | Standard Bagging | 0.6451 | 0.5157 | 50 | 0.0% | 2.11 |
| | Ridge | Lasso-Pruned Bagging | 0.6416 | 0.5182 | 50 | 0.0% | 1.77 |
| | Ridge | **SCSB** | 0.6504 | 0.5116 | **10** | **80.0%** | **0.51** (4.1x speedup) |
| | N/A | XGBoost | 0.3021 | 0.7732 | 100 | 0.0% | 0.51 |
| **cpu_act** | DecisionTree | Standard Bagging | 6.0061 | 0.9824 | 100 | 0.0% | 15.50 |
| | DecisionTree | Lasso-Pruned Bagging | 6.0149 | 0.9824 | 100 | 0.0% | 15.92 |
| | DecisionTree | **SCSB** | 6.1058 | 0.9821 | **66** | **34.0%** | **10.70** (1.45x speedup) |
| | Ridge | Standard Bagging | 92.3591 | 0.7293 | 50 | 0.0% | 2.34 |
| | Ridge | Lasso-Pruned Bagging | 92.4092 | 0.7292 | 50 | 0.0% | 2.14 |
| | Ridge | **SCSB** | **91.3468** | **0.7323** | **2** | **96.0%** | **2.03** (1.15x speedup) |
